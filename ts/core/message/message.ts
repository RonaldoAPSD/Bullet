namespace BE {
	...
	export enum MessagePriority {
		...
		/**
		 * Normal message priority, meaning this message is sent as soon as the queue allows.
		 */
		NORMAL,
	...
	export class Message{
		...
		/**
		 * Free-form context data to be included with the message.
		 */
		public context: any;
		 ...
		 * @param priority The priority of this message. Default: MessagePriority.NORMAL
		 */
