namespace BE {
	...
	/**
	 * The message manager resposible for sending message across the system.
	 */
	export class MessageBus {
		...
		/**
		 * Removes a subscription to the provided code usnig the provided handler.
		 ...
		 * @param time The delta time in miliseconds.
		 */
		public static update(time: number): void {
			...
			for (let i = 0; i < messageLimit; ++i) {
				let node = MessageBus._normalMessageQueue.pop() as MessageSubscriptionNode;
